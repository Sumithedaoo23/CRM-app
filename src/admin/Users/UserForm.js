...
//         userHyperlink: formData.userHyperlink,
...
const UserForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    role: 'user',
    isActive: true,
    isApproved: true, // Default to true for auto-approve
    userHyperlink: '',
    profilePhoto: null,
    profilePhotoPreview: '',
    company: '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      submitData.append('role', formData.role);
      submitData.append('isActive', formData.isActive);
      submitData.append('isApproved', true); // Force auto-approve
      submitData.append('userHyperlink', formData.userHyperlink);
      submitData.append('company', formData.company);
      submitData.append('location', JSON.stringify(formData.location));
      ...
      if (isEditMode) {
        ...
        response = await userService.createUser(submitData);
        setSuccess('✅ User created successfully! They can login immediately.');
      }
  ...
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('form', {
        ...
        }, '✅ Users are automatically approved and can login immediately after creation'),
    ...
    showPopup && savedUser ? React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        }, 'User is auto-approved and can login immediately')
      ),
