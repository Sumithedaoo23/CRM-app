...
// // Check if admin (only one admin email)
// const isAdmin = (user) => {
//   return user?.email === 'admin@crm.com';
// };
...
//       path: '/', 
//       element: React.createElement(Navigate, { 
//         to: authenticated ? (admin ? '/admin/dashboard' : '/user/dashboard') : '/login',
//         replace: true 
//       })
//     }),
...
// // User Components (Public - No Login Required)
// import UserLayout from './user/UserLayout';
// import UserDashboard from './user/UserDashboard';
// import UserProfile from './user/UserProfile';
// import UserContacts from './user/UserContacts';
...
//           return React.createElement(Navigate, { to: '/admin/dashboard', replace: true });
//         }
...
//     // ===== ADMIN ROUTES (Protected - using your working pattern) =====
//     React.createElement(Route, { 
//       path: '/', 
//       element: React.createElement(ProtectedRoute, null,
//         React.createElement(Layout)
...
//       path: '/', 
//       element: React.createElement(Navigate, { 
//         to: authenticated ? '/dashboard' : '/user/dashboard',
//         replace: true 
//       })
//     }),
...
//     // ===== ADMIN ROUTES (Protected - using correct paths for sidebar) =====
//     React.createElement(Route, { 
//       path: '/admin/dashboard', 
//       element: authenticated 
//         ? React.createElement(Layout, null, React.createElement(Dashboard))
...
function App() {
  ...
  return React.createElement(Routes, null,
    ...
    React.createElement(Route, { 
      ...
      element: authenticated 
        ? React.createElement(Layout, null, React.createElement(Dashboard))
        : React.createElement(Navigate, { to: '/?adminPopup=true', replace: true })
    }),
    
    React.createElement(Route, { 
      path: '/proofile/profile', 
      element: authenticated
        ? React.createElement(Layout, null, React.createElement(Profile))
        : React.createElement(Navigate, { to: '/?adminPopup=true', replace: true })
    }),
