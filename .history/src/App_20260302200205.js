...
import { useTheme } from './context/ThemeContext';
import Login from './pages/Login';
import Layout from './components/Layout/Layout'; // Changed from AdminLayout to Layout
import UserLayout from './user/UserLayout';
import Dashboard from './components/Dashboard/Dashboard';
import Users from './components/Users/Users';
import Contacts from './components/Contacts/Contacts';
...
const ProtectedRoute = ({ children, requiredRole = null }) => {
  ...
  if (requiredRole === 'user' && isAdmin(user)) {
    return React.createElement(Navigate, { 
      to: './components/Dashboard/Dashboard.js', 
      replace: true 
    });
  }
  ...
  // Return appropriate layout based on role
  if (isAdmin(user)) {
    return React.createElement(Layout, null, children); // Changed to Layout
  } else {
    return React.createElement(UserLayout, null, children);
  }
};
