...
function App() {
  ...
  return React.createElement(Routes, null,
    // Login route - redirect to user dashboard if already logged in as user
    React.createElement(Route, { 
      path: '/login', 
      element: (() => {
        if (authenticated && !admin) {
          return React.createElement(Navigate, { to: '/user-dashboard', replace: true });
        }
        if (authenticated && admin) {
    ...
    // User Dashboard (matches your Login.js navigation)
    React.createElement(Route, { 
      path: '/user-dashboard', 
    ...
    // Admin Dashboard redirect for user panel (admins can't access)
    React.createElement(Route, { 
      path: '/dashboard', 
      element: React.createElement(Navigate, { to: '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      path: '/', 
      element: React.createElement(Navigate, { 
        to: authenticated && !admin ? '/user-dashboard' : '/login',
        replace: true 
      })
    }),
