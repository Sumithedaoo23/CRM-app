...
function App() {
  return React.createElement('div', null,
    React.createElement('nav', { style: { padding: '10px', backgroundColor: '#333' } },
      React.createElement(Link, { to: '/', style: { margin: '10px', color: 'white' } }, 'Home'),
      React.createElement(Link, { to: '/user/dashboard', style: { margin: '10px', color: 'white' } }, 'Dashboard')
    ),
    
    React.createElement(Routes, null,
      React.createElement(Route, { 
        path: '/', 
        element: React.createElement('div', { style: { padding: '20px' } }, 'Home Page') 
      }),
      React.createElement(Route, { 
        path: '/user/dashboard', 
