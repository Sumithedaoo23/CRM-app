...
// // Auth check helper functions (using context)
...
//   // Check for admin required routes
...
//   // Check for user required routes (non-admin)
  ...
  return React.createElement('div', { 
    ...
    React.createElement('div', {
      style: {
        ...
        display: 'flex',
        flexDirection: 'column',
        marginLeft: isDesktop && sidebarOpen ? '300px' : '0',
        transition: 'margin-left 0.3s ease-in-out',
        width: isDesktop && sidebarOpen ? 'calc(100% - 300px)' : '100%'
      }
    },
