      ...
      React.createElement('form', {
        ...
        React.createElement('div', {
          ...
          React.createElement('input', {
            ...
            onFocus: (e) => e.target.style.borderColor = userType === 'admin' ? '#3b82f6' : '#10b981',
        ...
        React.createElement('button', {
          ...
          onMouseEnter: (e) => {
            if (!loading) {
              e.target.style.backgroundColor = userType === 'admin' ? '#2563eb' : '#059669';
            }
          },
          onMouseLeave: (e) => {
            if (!loading) {
              e.target.style.backgroundColor = userType === 'admin' ? '#3b82f6' : '#10b981';
            }
          }
        }, loading ? 'Logging in...' : `Sign In as ${userType === 'admin' ? 'Admin' : 'User'}`)
      ),
