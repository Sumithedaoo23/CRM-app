  ...
  return React.createElement(Routes, null,
    ...
    React.createElement(Route, { 
      ...
      element: authenticated && admin 
        ...
        : React.createElement(Navigate, { to: authenticated ? '/user/dashboard' : '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      ...
      element: authenticated && admin
        ...
        : React.createElement(Navigate, { to: authenticated ? '/user/profile' : '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      ...
      element: authenticated && admin
        ...
        : React.createElement(Navigate, { to: authenticated ? '/user/tickets' : '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      ...
      element: authenticated && !admin
        ...
        : React.createElement(Navigate, { to: authenticated ? '/dashboard' : '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      ...
      element: authenticated && !admin
        ...
        : React.createElement(Navigate, { to: authenticated ? '/profile' : '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      ...
      element: authenticated && !admin
        ...
        : React.createElement(Navigate, { to: authenticated ? '/tickets' : '/login', replace: true })
    }),
