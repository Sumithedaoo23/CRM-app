...
//   // Admin menu items - note the /admin prefix
//   const menuItems = [
...
//             }, item.icon),
//             item.label,
//             item.path === '/admin/tickets' && React.createElement('span', {
//               style: {
//                 marginLeft: 'auto',
//                 backgroundColor: '#ef4444',
//                 color: 'white',
...
add direct button of admin dashboard it can be accessed in directly or any code add 4 digit soemting because it was not show  admin dashboard of it admin dashboard cant see it and also in landig page of it add pop login to thier user login and also in admin dashboard cant see fixed the issue or whatsevr yo  want  to do for my both dashbord see of it it use login r nt used just fixed it