...
const AdminUsers = () => {
  ...
  return React.createElement('div', {
    ...
    // User Profile Modal - Complete view with all details
    showUserModal && modalUser && React.createElement('div', {
      style: {
        position: 'fixed',
        top: 0,
      ...
      React.createElement('div', {
        ...
        React.createElement('div', {
          ...
          React.createElement('button', {
            onClick: () => window.open(modalUser.userHyperlink || `https://crm.com/user/${modalUser._id}`, '_blank'),
            style: {
              marginTop: '8px',
              padding: '6px 12px',
              backgroundColor: 'white',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: '14px', fontWeight: '500', color: '#3b82f6', wordBreak: 'break-all' }}>
              {modalUser.email || 'N/A'}
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px' }}>Member Since</div>
            <div style={{ fontSize: '14px', fontWeight: '500', color: '#111827' }}>
              {modalUser.createdAt ? new Date(modalUser.createdAt).toLocaleDateString('en-US', {
                year: 'numeric',
                month: 'long',
          ...
          <div style={{
            ...
            <div style={{ fontSize: '11px', color: '#6b7280', marginBottom: '4px' }}>User ID</div>
            <div style={{ fontSize: '13px', fontWeight: '500', color: '#6b7280', fontFamily: 'monospace' }}>
              {modalUser._id?.slice(-8) || 'N/A'}
            </div>
          </div>
        </div>

        {/* Location Section */}
        {modalUser.location && (modalUser.location.city || modalUser.location.country) && (
          <div style={{
            padding: '16px',
            backgroundColor: '#f9fafb',
            borderRadius: '8px',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
              ...
              <span style={{ fontSize: '14px', fontWeight: '600', color: '#111827' }}>Location</span>
            </div>
            <p style={{ fontSize: '14px', color: '#4b5563', marginLeft: '24px' }}>
              {[
