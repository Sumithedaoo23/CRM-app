...
const UserForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    role: 'user',
    isActive: true,
    userHyperlink: '' // New field for manual hyperlink
  });
  ...
  const generateDefaultCredentials = () => {
    ...
    setFormData(prev => ({
      ...
      email: defaultEmail,
      password: defaultPassword,
      userHyperlink: `https://crm.com/user/${randomNum}` // Auto-generate hyperlink
    }));
    setGeneratedPassword(defaultPassword);
  };
  ...
  return React.createElement('div', {
    ...
    {showPopup && savedUser && React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        }, React.createElement('strong', null, 'Name: '), `${savedUser.firstName || ''} ${savedUser.lastName || ''}`),
        ...
        }, React.createElement('strong', null, 'Email: '), savedUser.email),
        
        React.createElement('p', {
          style: {
            fontSize: '13px'
          }
        }, React.createElement('strong', null, 'Role: '), savedUser.role === 'admin' ? 'Admin' : 'User')
      ),
