...
const UserForm = () => {
  ...
  useEffect(() => {
    if (isEditMode) {
      ...
      // Generate default email and password for new users
  ...
  const handleEmailChange = (e) => {
    ...
    // If email is empty or doesn't end with @crm.com, auto-complete
  ...
  const passwordSection = !isEditMode ? React.createElement('div', {
    ...
    // Email field with @crm.com auto-complete
    React.createElement('div', {
      style: {
        marginBottom: '16px'
      }
    ...
    }, '💡 Password will be auto-generated. You can copy it or regenerate.')
  ) : null;
    ...
    React.createElement('div', {
      ...
      React.createElement('form', {
        ...
        React.createElement('div', {
          ...
          // Email (only show if not in edit mode or if we want to allow email changes)
          !isEditMode ? null : React.createElement('div', {
            style: {
              gridColumn: 'span 2'
            }
          },
