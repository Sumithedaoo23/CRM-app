...
//     // Stats Cards - Now with 4 cards including Contacts
//     React.createElement('div', {
//       style: {
//         display: 'grid',
...
//           }
//         },
//           React.createElement('span', null, `✅ ${stats.counts.activeContacts || 0} Active`),
//           React.createElement('span', null, `❌ ${stats.counts.inactiveContacts || 0} Inactive`)
//         )
//       ),
...
//     stats.recentActivities.contacts && stats.recentActivities.contacts.length > 0 && React.createElement('div', {
//       style: {
//         backgroundColor: '#ffffff',
//         borderRadius: '12px',
//         padding: '24px',
...
//         }
//       },
//         stats.recentActivities.contacts.map((contact, index) => (
//           React.createElement('div', {
//             key: index,
//             style: {
//               padding: '16px',
...
//                 fontSize: '11px',
//                 fontWeight: '500',
//                 backgroundColor: contact.status === 'Active' ? '#d1fae5' : '#fee2e2',
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', {
          ...
          }, `✅ ${stats.counts.activeContacts || 0} Active`),
          ...
          }, `❌ ${stats.counts.inactiveContacts || 0} Inactive`)
        )
      ),
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        ['pending', 'in-progress', 'resolved', 'closed', 'rejected'].map((status) => {
          const colors = getStatusColors(status);
          const count = stats.ticketStats[status] || 0;
