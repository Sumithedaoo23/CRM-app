...
// Main Layout component with props
const MainLayout = ({ children, user, onLogout, isDark, onThemeToggle }) => {
  const [sidebarOpen, setSidebarOpen] = React.useState(false);
...
// Protected Route wrapper with context
const ProtectedRoute = ({ children }) => {
...
function App() {
  return React.createElement(Routes, null,
    ...
    React.createElement(Route, { 
      path: '/users', 
      element: React.createElement(ProtectedRoute, null,
        isAdmin() ? React.createElement(Users) : React.createElement(Navigate, { to: '/dashboard', replace: true })
      )
    }),
    ...
    React.createElement(Route, { 
      path: '/contacts', 
      element: React.createElement(ProtectedRoute, null,
        isAdmin() ? React.createElement(Contacts) : React.createElement(Navigate, { to: '/dashboard', replace: true })
      )
    }),
    ...
    React.createElement(Route, { 
      path: '/leads', 
      element: React.createElement(ProtectedRoute, null,
        isAdmin() ? React.createElement(Leads) : React.createElement(Navigate, { to: '/dashboard', replace: true })
      )
    }),
    ...
    React.createElement(Route, { 
      path: '/roles', 
      element: React.createElement(ProtectedRoute, null,
        isAdmin() ? React.createElement(Roles) : React.createElement(Navigate, { to: '/dashboard', replace: true })
      )
    }),
    ...
    React.createElement(Route, { 
      path: '/permissions', 
      element: React.createElement(ProtectedRoute, null,
        isAdmin() ? React.createElement(Permissions) : React.createElement(Navigate, { to: '/dashboard', replace: true })
      )
    }),
