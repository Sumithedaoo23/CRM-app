...
const UserProfile = () => {
  return React.createElement('div', {
    ...
    React.createElement('h1', { style: { fontSize: '24px', fontWeight: '700', color: '#111827' } }, 'User Profile'),
    React.createElement('p', { style: { color: '#6b7280', marginTop: '16px' } }, 'Profile page coming soon...')
  );
};
