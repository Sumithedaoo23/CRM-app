...
const UserDashboard = () => {
  return React.createElement('div', {
    ...
    }, 'If you can see this, the routing and components are working correctly.'),
    ...
    React.createElement('div', {
      ...
      React.createElement('div', {
        ...
        React.createElement('p', { style: { fontSize: '14px' } }, 'Sidebar Working')
      ),
      ...
      React.createElement('div', {
        ...
        React.createElement('p', { style: { fontSize: '14px' } }, 'Header Working')
      )
    )
  );
};
