  ...
  const findAdminContact = async () => {
    try {
      ...
      if (admins.length > 0 && !selectedAdmin) {
        ...
        // If no existing conversation, select the first admin
          ...
          conversations.map((conv) =>
            React.createElement('div', {
              ...
              style: {
                padding: '12px 16px',
                cursor: 'pointer',
                backgroundColor: selectedAdmin?._id === conv._id ? '#f0f9ff' : 'white',
              ...
              React.createElement('div', {
                ...
                conv.profilePhoto
                  ...
                  : React.createElement('div', {
                    ...
                    }, (conv.firstName?.[0] || 'A') + (conv.lastName?.[0] || 'A')),
                ...
                React.createElement('div', {
                  ...
                  React.createElement('div', {
                    ...
                    }, `${conv.firstName || ''} ${conv.lastName || ''}`.trim() || 'Admin'),
            ...
            React.createElement('div', {
              ...
              selectedAdmin.profilePhoto
                ...
                : React.createElement('div', {
                  ...
                  }, (selectedAdmin.firstName?.[0] || 'A') + (selectedAdmin.lastName?.[0] || 'A')),
