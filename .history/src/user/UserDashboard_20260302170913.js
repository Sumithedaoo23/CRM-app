...
const UserDashboard = () => {
  return React.createElement('div', {
    ...
    React.createElement('div', {
      ...
      React.createElement('p', { style: { margin: '5px 0' } }, '📍 Path: /user/dashboard'),
      React.createElement('p', { style: { margin: '5px 0' } }, '🕒 Time: ' + new Date().toLocaleTimeString()),
      React.createElement('p', { style: { margin: '5px 0' } }, '📅 Date: ' + new Date().toLocaleDateString())
    )
  );
};
