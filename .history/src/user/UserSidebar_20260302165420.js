...
const UserSidebar = ({ isOpen, onClose, user, onLogout }) => {
  ...
  const menuItems = [
    { path: './UserDashboard.js', label: 'Dashboard', icon: '📊' },
    { path: './UserProfile.js', label: 'Profile', icon: '👤' },
    { path: './UserTickets.js', label: 'My Tickets', icon: '🎫' },
    { path: './GenerateTicket.js', label: 'Generate Ticket', icon: '➕' },
    { path: './TicketStatus.js', label: 'Ticket Status', icon: '📋' },
  ];
