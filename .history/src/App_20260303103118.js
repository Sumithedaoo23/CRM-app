...
function App() {
  ...
  return React.createElement(Routes, null,
    ...
    React.createElement(Route, { 
      path: '/dashboard', 
      element: isAuthenticated(user) && isAdmin(user) 
        ? React.createElement(AdminLayout, null, React.createElement(Dashboard))
        : React.createElement(Navigate, { to: isAuthenticated(user) ? '/user/dashboard' : '/login', replace: true })
    }),
    
    React.createElement(Route, { 
      path: '/profile', 
      element: isAuthenticated(user) && isAdmin(user)
        ? React.createElement(AdminLayout, null, React.createElement(Profile))
        : React.createElement(Navigate, { to: isAuthenticated(user) ? '/user/profile' : '/login', replace: true })
    }),
    
    React.createElement(Route, { 
      path: '/users', 
      element: isAuthenticated(user) && isAdmin(user)
        ? React.createElement(AdminLayout, null, React.createElement(Users))
    ...
    React.createElement(Route, { 
      path: '/contacts', 
      element: isAuthenticated(user) && isAdmin(user)
        ? React.createElement(AdminLayout, null, React.createElement(Contacts))
        : React.createElement(Navigate, { to: '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      path: '/leads', 
      element: isAuthenticated(user) && isAdmin(user)
        ? React.createElement(AdminLayout, null, React.createElement(Leads))
        : React.createElement(Navigate, { to: '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      path: '/roles', 
      element: isAuthenticated(user) && isAdmin(user)
        ? React.createElement(AdminLayout, null, React.createElement(Roles))
        : React.createElement(Navigate, { to: '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      path: '/permissions', 
      element: isAuthenticated(user) && isAdmin(user)
        ? React.createElement(AdminLayout, null, React.createElement(Permissions))
        : React.createElement(Navigate, { to: '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      path: '/tickets', 
      element: isAuthenticated(user) && isAdmin(user)
        ? React.createElement(AdminLayout, null, React.createElement(Tickets))
        : React.createElement(Navigate, { to: isAuthenticated(user) ? '/user/tickets' : '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      path: '/user/dashboard', 
      element: isAuthenticated(user) && !isAdmin(user)
        ? React.createElement(UserLayoutWrapper, null, React.createElement(UserDashboard))
        : React.createElement(Navigate, { to: isAuthenticated(user) ? '/dashboard' : '/login', replace: true })
    }),
    
    React.createElement(Route, { 
      path: '/user/profile', 
      element: isAuthenticated(user) && !isAdmin(user)
        ? React.createElement(UserLayoutWrapper, null, React.createElement(UserProfile))
        : React.createElement(Navigate, { to: isAuthenticated(user) ? '/profile' : '/login', replace: true })
    }),
    
    React.createElement(Route, { 
      path: '/user/tickets', 
      element: isAuthenticated(user) && !isAdmin(user)
        ? React.createElement(UserLayoutWrapper, null, React.createElement(UserTickets))
        : React.createElement(Navigate, { to: isAuthenticated(user) ? '/tickets' : '/login', replace: true })
    }),
    
    React.createElement(Route, { 
      path: '/user/generate-ticket', 
      element: isAuthenticated(user) && !isAdmin(user)
        ? React.createElement(UserLayoutWrapper, null, React.createElement(GenerateTicket))
        : React.createElement(Navigate, { to: '/login', replace: true })
    }),
    ...
    React.createElement(Route, { 
      path: '/user/ticket-status', 
      element: isAuthenticated(user) && !isAdmin(user)
        ? React.createElement(UserLayoutWrapper, null, React.createElement(TicketStatus))
        : React.createElement(Navigate, { to: '/login', replace: true })
    }),
