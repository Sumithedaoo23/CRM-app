...
// // Update user - FIXED for admin profile with file upload support
// app.put('/api/users/:id', upload.single('profilePhoto'), async (req, res) => {
//   try {
//     if (!req.params.id.match(/^[0-9a-fA-F]{24}$/)) {
//       return res.status(400).json({
//         success: false,
...
//     // Only add phone if it's provided
//     if (cleanedPhone !== undefined && cleanedPhone !== '') {
//       updateData.phone = cleanedPhone;
//     }
...
//     // If file was uploaded, add profile photo path
//     if (req.file) {
//       updateData.profilePhoto = `/uploads/${req.file.filename}`;
//       console.log('🖼️ Profile photo updated:', updateData.profilePhoto);
//     }
...
// // Temporary route to create/update admin
...
//   console.log(`   │  ├─ POST /api/users (AUTO-APPROVE)`);
//   console.log(`   │  ├─ GET  /api/users/:id`);
//   console.log(`   │  ├─ PUT  /api/users/:id (with file upload)`);
//   console.log(`   │  └─ DELETE /api/users/:id`);
//   console.log('   ├─ Ticket Routes');
//   console.log(`   │  ├─ GET  /api/tickets/all`);
//   console.log(`   │  ├─ GET  /api/tickets/user/:userId`);
...
//   console.log(`      └─ GET  /api/setup-admin (create/update admin)`);
//   console.log('='.repeat(50) + '\n');
// });