...
// ============ USER ROUTES (Direct - with file upload support) ============
...
app.listen(PORT, () => {
  ...
  console.log('   ├─ Auth Routes');
  console.log(`   │  └─ POST /api/auth/login`);
  console.log('   ├─ User Routes (with photo upload)');
  console.log(`   │  ├─ GET  /api/users`);
  console.log(`   │  ├─ POST /api/users (multipart/form-data)`);
  console.log(`   │  ├─ GET  /api/users/:id`);
  console.log(`   │  ├─ PUT  /api/users/:id (multipart/form-data)`);
  console.log(`   │  ├─ DELETE /api/users/:id`);
  console.log(`   │  ├─ GET  /api/users/export/pdf`);
  console.log(`   │  └─ GET  /api/users/:id/export/pdf`);
  console.log('   ├─ Ticket Routes');
