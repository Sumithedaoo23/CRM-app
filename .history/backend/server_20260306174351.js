...
// Contact routes (commented out until files exist)
// app.use('/api/contacts', contactRoutes);

// Lead routes (commented out until files exist)
// app.use('/api/leads', leadRoutes);

// Role routes (commented out until files exist)
// app.use('/api/roles', roleRoutes);

// Permission routes (commented out until files exist)
// app.use('/api/permissions', permissionRoutes);

// Admin routes (commented out until files exist)
// app.use('/api/admin', adminRoutes);

// Dashboard routes (commented out until files exist)
// app.use('/api/dashboard', dashboardRoutes);

// Hyperlink routes (commented out until files exist)
// app.use('/api/hyperlinks', hyperlinkRoutes);
