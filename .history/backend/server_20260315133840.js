...
app.get('/api/fix-admin', async (req, res) => {
  try {
    ...
    if (admin) {
      ...
      admin.firstName = 'Sumit';
      admin.lastName = 'Hedaoo';
    ...
    res.json({
      success: true,
      message: 'Admin created/updated successfully with your credentials',
      data: {
        email: adminEmail,
...
app.listen(PORT, () => {
  ...
  console.log(`      └─ GET  /api/fix-admin (Create/Update Admin with your credentials)`);
  console.log('='.repeat(50) + '\n');
});