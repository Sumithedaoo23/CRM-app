...
//     } else {
//       // Check password for existing users (optional - remove if you want to skip password check)
//       if (password) {
...
// // Get single user - Fixed with ID validation
...
// // Update user - Fixed with ID validation
...
//   console.log('   ├─ User Routes (with photo upload support in userRoutes.js)');
...
// app.use('/api/tickets', ticketRoutes);
// app.use('/api/users', userRoutes);
// app.use('/api/auth', authRoutes); // USING THE IMPORTED ROUTES - NOT DUPLICATING
// app.use('/api/dashboard', dashboardRoutes);
// app.use('/api/contacts', contactRoutes);
// app.use('/api/messages', messageRoutes);
// app.use('/api/roles', roleRoutes);
...
//   console.log(`   │  ├─ GET  /`);
//   console.log(`   │  └─ GET  /api/test/db`);
//   console.log('   ├─ Auth Routes (from authRoutes.js)');
//   console.log(`   │  └─ POST /api/auth/login`);
...
//       lastName,
//       email: email.toLowerCase().trim(),
//       password: password || 'password123', // Default password for users
//       phone: cleanedPhone,
//       role: role || 'user',
//       company: company || '',
//       address: address || {},
...
//     const { firstName, lastName, email, phone, role, company, address, isActive, isApproved } = req.body;
...
//     doc.text(`Company: ${user.company || 'N/A'}`);
//     doc.text(`Status: ${user.isActive ? 'Active' : 'Inactive'}`);
//     doc.text(`Approved: ${user.isApproved ? 'Yes' : 'No'}`);
//     doc.text(`Created: ${new Date(user.createdAt).toLocaleDateString()}`);
...
//   console.log(`   │  ├─ PUT  /api/users/reject/:id`);
//   console.log(`   │  ├─ DELETE /api/users/:id`);
//   console.log(`   │  ├─ GET  /api/users/export/pdf`);
//   console.log(`   │  └─ GET  /api/users/:id/export/pdf`);
//   console.log('   ├─ Ticket Routes');
